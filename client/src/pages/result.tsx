...
import { ArrowLeft, RefreshCw, AlertTriangle, CheckCircle2, Info, Activity, ShieldAlert } from "lucide-react";
...
export default function Result() {
  ...
  const [prediction, setPrediction] = useState<{ risk: "Low" | "Moderate" | "High", confidence: number } | null>(null);
  ...
  return (
    <div className="min-h-screen bg-muted/30 py-12 px-4 flex flex-col items-center relative overflow-hidden">
      ...
      <div className={`absolute top-20 right-0 w-[500px] h-[500px] rounded-full blur-[100px] pointer-events-none opacity-20 ${
        prediction.risk === "High" ? "bg-red-500" : 
        prediction.risk === "Moderate" ? "bg-amber-500" : 
        "bg-primary"
      }`} />
                ...
                <div className="space-y-6 max-w-md">
                  ...
                  <p className="text-foreground text-lg leading-relaxed font-medium">
                    {prediction.risk === "High" 
                      ? "Our model indicates a higher likelihood that you might benefit from seeking professional mental health support. The combination of your inputs highly correlates with individuals seeking treatment."
                      : prediction.risk === "Moderate"
                      ? "Our model suggests a moderate probability. It may be beneficial to proactively monitor your well-being, manage stress, and utilize available resources."
                      : "Our model indicates a lower probability for requiring immediate clinical intervention, but well-being is an ongoing practice. Keep up the good work maintaining balance."}
                  </p>
                </div>
                ...
                <div className="relative w-56 h-56 flex items-center justify-center shrink-0">
                  ...
                  <svg className="w-full h-full -rotate-90 relative z-10" viewBox="0 0 100 100">
                    ...
                    <motion.circle 
                      ...
                      animate={{ strokeDashoffset: 276.46 - (276.46 * prediction.confidence) / 100 }}
                      ...
                      className={prediction.risk === "High" ? "text-red-500" : prediction.risk === "Moderate" ? "text-amber-500" : "text-primary"}
                      strokeLinecap="round"
                    />
                  </svg>
